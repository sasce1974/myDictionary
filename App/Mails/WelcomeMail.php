...
class WelcomeMail
{
    ...
    public function setMessage($subject, $content){
        ...
        $this->message .= "<img style='vertical-align: middle;margin:auto;' src='https://www.dictionary.papucraft.com/images/logo_dictionary1.svg' alt='logo' width=80 height='auto'>\r\n";
